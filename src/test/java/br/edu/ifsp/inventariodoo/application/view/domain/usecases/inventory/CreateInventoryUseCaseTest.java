package br.edu.ifsp.inventariodoo.application.view.domain.usecases.inventory;

import br.edu.ifsp.inventariodoo.application.repository.inmemory.InMemoryInventoryDAO;
...
class CreateInventoryUseCaseTest {
    ...
    void CreateValidInventory(){
        ...
        Inventory inventory1 = Inventory.withLists(premier, inventors, list1);
    ...
    void CreateInventoryWithoutPresident(){
        ...
        Inventory inventory1 = Inventory.withLists(null,inventors,list1);
    ...
    void CreateInventoryWithoutInventor(){
        ...
        Inventory inventory1 = Inventory.withLists(premier,null,list1);
        assertThrows(IllegalArgumentException.class, () -> createInventoryUseCase.insert(inventory1));
    }
    ...
    void CreateInventoryWithoutRegisters(){
        ...
        Inventory inventory1 = Inventory.withLists(premier,inventors,null);
        assertThrows(IllegalArgumentException.class, () -> createInventoryUseCase.insert(inventory1));
    }
