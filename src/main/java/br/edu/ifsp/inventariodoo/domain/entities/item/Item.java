...
import br.edu.ifsp.inventariodoo.domain.entities.user.User;
...
public class Item {
    ...
    public Item(String tag, String description, String status, Goods goods, User responsible, Place place) {
        this.tag = tag;
        this.description = description;
        this.status = status;
        this.goods = goods;
